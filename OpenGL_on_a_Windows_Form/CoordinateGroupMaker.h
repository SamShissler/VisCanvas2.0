...
namespace CppCLRWinformsProjekt {
	...
	public ref class CoordinateGroupMaker : public System::Windows::Forms::Form
	{
	public: CoordinateGroupMaker(vector<int> *avalibleCoordinates)
	{
		InitializeComponent();
	...
	protected:~CoordinateGroupMaker()
	{
		if (components)
		{
			delete components;
...
#pragma region
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->confirmButton->Click += gcnew System::EventHandler(this, &CoordinateGroupMaker::onConfirm);
			   // 
			   // Form1
			   // 
