...
namespace CppCLRWinformsProjekt {
	...
	public ref class RatioGroupStarting : public System::Windows::Forms::Form
	{
	public: RatioGroupStarting()
	{
		numGroups = 1;
		InitializeComponent();
		buildTable();
...
#pragma region
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->saveButton->Click += gcnew System::EventHandler(this, &RatioGroupStarting::handleClose);
			   // 
			   // Form1
			   // 
			   ...
			   this->Name = L"Ratio Group Starting";
			   this->Text = L"Ratio Group Starting";
