...
namespace CppCLRWinformsProjekt {
	...
	public ref class RatioGrouping : public System::Windows::Forms::Form
	{
	public: RatioGrouping(DataGridView^ pd, std::vector<std::string>* idv)
	{
		passedData = pd;
		ids = idv;
		InitializeComponent();
	...
	public:
		...
		RatioData(String^ k, int p, float i)
		{
			key = k;
			position = p;
			intervalToNext = i;
...
#pragma region
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->confirmButton->Click += gcnew System::EventHandler(this, &RatioGrouping::updateScheme);
			   // 
			   // Form1
			   // 
			   ...
			   this->Name = L"Ratio Grouping";
			   this->Text = L"Ratio Grouping";
...
#pragma endregion
	...
	public: std::vector<std::string>* getRatioVector();
	};
}
